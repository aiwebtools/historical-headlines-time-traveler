        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="w-full md:w-1/2 mb-10 md:mb-0 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <a 
                ...
                aria-label="Start using Historical Headlines GPT"
              >
                Experience Now
              ...
              <a 
                ...
                aria-label="Learn more about how Historical Headlines GPT works"
              >
                Learn More
              </a>
            </div>
          ...
          <div className="w-full md:w-1/2 px-6">
            <div className="relative max-w-md mx-auto">
              {/* Newspaper effect */}
              <article className="relative news-paper p-8 rounded shadow-xl transform rotate-1 z-20">
                <header className="border-b-2 border-black pb-2 mb-4">
                  ...
                  <time className="font-news text-black text-sm text-center block">July 20, 1969</time>
                </header>
